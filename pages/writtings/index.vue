<template>
  <div class="min-h-screen">
    ...
    <div class="container flex flex-wrap justify-center lg:justify-start gap-2 md:gap-4 pt-10 pb-20">
      <NuxtLink v-for="i in 5" :to="`/writtings/${i}`" class="md:w-[20rem] lg:w-[24rem]">
        <div class="card bg-base-100 card-lg shadow-sm">
          <div class="card-body">
            ...
            <p class="text-xs border-base-300 border-l-3 pl-3 mb-2">
              <time class="text-base-300">2025-03-20</time>
            </p>
