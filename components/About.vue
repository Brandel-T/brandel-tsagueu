    ...
    <section class="about page-section">
        ...
        <div class="section-body !-z-1">
            <div class="about-content">
                ...
                <ContentDoc path="/about" class="body-text text-center md:text-left font-light backdrop-blur border border-tertiary rounded-md py-4 px-6 bg-gradient" />
                ...
                <div class="flex justify-center md:justify-start gap-x-12 mt-6">
                    <div class="body-text flex items-center gap-2 -z-10">
                        <strong class="text-[2.5rem] md:text-[3.5rem] font-normal">2+</strong> years Experience
                    </div>
                    <div class="body-text flex items-center gap-2 -z-10">
                        <IconLocation class="!w-[2.5rem] !h-[2.5rem] md:!w-[3.5rem] md:!h-[3.5rem]" />Germany, RLP
                    </div>
                </div>
                <div class="mb-4 text-accent text-center md:text-left text-xl md:text-2xl mt-12 capitalize">My interests</div>
...
export default {
    async setup() {
        ...
        useAsyncData('about', () => queryContent('/about').findOne())
            .then(({ data }) => {
        ...
        useAbout()
            .then(({ data, pending }) => {
                ...
                interests.value = data.value.data.attributes.interests.data.map((interest) => interest.attributes.name)
